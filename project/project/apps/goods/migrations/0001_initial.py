# Generated by Django 2.2.5 on 2020-12-23 11:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.GoodsCategory', verbose_name='第三级类别')),
            ],
            options={
                'verbose_name': '商品SKU',
                'db_table': 'tb_sku',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.IntegerField(default=0, verbose_name='总评价')),
                ...
                ('category1', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat1_spu', to='goods.GoodsCategory', verbose_name='一级分类')),
                ('category2', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat2_spu', to='goods.GoodsCategory', verbose_name='二级分类')),
                ('category3', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat3_spu', to='goods.GoodsCategory', verbose_name='三级分类')),
            ],
            options={
                'verbose_name': '商品',
                'db_table': 'tb_spu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.SpecificationOption', verbose_name='选项')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specs', to='goods.SKU', verbose_name='SKU')),
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.SPUSpecification', verbose_name='规格')),
            ],
            options={
                'verbose_name': 'SKU规格',
        ...
        migrations.AddField(
            model_name='sku',
            name='spu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skus', to='goods.SPU', verbose_name='SPU商品'),
        ),
        migrations.CreateModel(
            name='GoodsChannel',
            fields=[
                ...
                ('url', models.CharField(max_length=50, verbose_name='频道页面地址')),
                ('sequence', models.IntegerField(verbose_name='组内顺序')),
                ('category', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='一级商品类别')),
            ],
            options={
                'verbose_name': '商品频道',
